...
$sql = "SELECT tutors.tutor_id, tutors.name_en, users.email, tutors.status 
        ...
        WHERE tutors.status IN ('forwarded_to_sss', 'selected', 'called')";
            ...
            <tr>
                ...
                <td>
                    <div class="actions">
                        ...
                        <?php if ($tutor['status'] == 'forwarded_to_sss'): ?>
                        <form action="process_tutor.php" method="post">
                            <input type="hidden" name="tutor_id" value="<?php echo $tutor['tutor_id']; ?>">
                            <input type="hidden" name="action" value="forward_provc">
                            <input type="text" name="comments" placeholder="Enter comments">
                            <button type="submit">Forward to Pro VC</button>
                        </form>
                        <form action="process_tutor.php" method="post">
                            <input type="hidden" name="tutor_id" value="<?php echo $tutor['tutor_id']; ?>">
                            <input type="hidden" name="action" value="send_back_dean">
                            <input type="text" name="comments" placeholder="Enter comments">
                            <button type="submit">Send Back to Dean</button>
                        </form>
                        <?php elseif ($tutor['status'] == 'selected'): ?>
                        <form action="process_tutor.php" method="post">
                            <input type="hidden" name="tutor_id" value="<?php echo $tutor['tutor_id']; ?>">
                            <input type="hidden" name="action" value="call_candidate">
                            <input type="text" name="comments" placeholder="Enter comments">
                            <button type="submit">Call Candidate</button>
                        </form>
                        <?php endif; ?>
                        <form action="process_tutor.php" method="post">
                            <input type="hidden" name="tutor_id" value="<?php echo $tutor['tutor_id']; ?>">
