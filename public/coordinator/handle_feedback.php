...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Notify the tutor via email (assuming email function is defined in functions.php)
    $tutor = getTutorById($tutor_id);
    $subject = "Feedback from Dean";
    $message = "Dear " . $tutor['name_en'] . ",\n\nYou have received feedback from the Dean:\n\n" . $comments;
    sendEmail($tutor['email'], $subject, $message);
...
<body>
    <h2>Handle Feedback from Dean</h2>
